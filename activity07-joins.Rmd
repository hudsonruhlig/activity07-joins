...
Looking at the websites there are no Denny's outside of the United States and there are La Quinta's outside of the United States.
...
We would need to join the datasets and isolate the variables of interest (addresses).
...
According to the data there are no Denny's outside of the United States that we must worry about.
...
Another way to do this would be to create a new variable (called, say, `country`), then filter on this new variable.
...
After data summarization of the dennys data, the state with the fewest Denny's 
is Delaware.
...
After data summarization of the laquinta_us data, the state with the fewest 
La Quinta's is Maine.

Is this surprising to you? Why or why not?

**Response**:

Not necessarily, La Quinta seems to be a much more popular hotel in the center
to southern parts of the United States, and Maine is very far North.
...
the top 5 states with the most Denny's locations per thousand square miles are
District of Colombia, Rhode Island, Florida, Maryland, and New Jersey, 
respectively.
...
The top 5 states with the most La Quinta locations per thousand miles are
Rhode Island, Florida, Connecticut, Maryland, and Texas, respectively.
...
The resulting dataset would not add all of the locations that we would like to
see, this could affect results
